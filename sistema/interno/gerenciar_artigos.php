...
<html>
    <head>
        ...
        <title>Artigos - Homeopatias.com</title>
        ...
        <script>
            ...
            $(document).ready(function(){
                ...
                $("#modal-confirma-deleta").on('show.bs.modal', function(e) {
                    ...
                    $(this).find('#nome-artigo').text(
                        $(e.relatedTarget).parent().siblings('.titulo').text()
                    );
                });
                // passa os dados do artigo para o modal para a edição
                $("#modal-edita-artigo").on('show.bs.modal', function(e) {
                    $(this).find('#id').val(
    ...
    <body>
        <?php
            ...
            // mensagem a ser exibida acima da listagem de artigos, caso seja necessário
            $mensagem = "";
            ...
            // exibe artigos apenas para administradores logados
            if(isset($_SESSION["usuario"]) && unserialize($_SESSION["usuario"]) instanceof Administrador
               && unserialize($_SESSION["usuario"])->getNivelAdmin() === "administrador") {
                ...
                if(isset($_POST["submit"])) {
                    ...
                    // se todos os dados estão válidos, o artigo é criado
                    if($tituloValido && $autorValido && $conteudoValido) {
                        ...
                        if($sucesso){
                            ...
                            $mensagem = "Erro na inserção de artigo";
                        }
                ...
                while ($linha = $query->fetch()) {
                    ...
                    $tabela .= " data-target=\"#modal-edita-artigo\">";
                    $tabela .= "<i class=\"fa fa-pencil\"></i></a></td>";
                    $tabela .= "    <td><a data-href=\"rotinas/artigo/remover_artigo.php?id=";
        ...
        <div class="col-sm-12">
            <div class="center-block col-sm-12 no-float">
                <section class="conteudo">
                    ...
                    ?>
                    <a href="#" class="btn" data-toggle="modal" data-target="#modal-novo-artigo">
                        <i href="#" class="fa fa-plus"></i>
                        <p style="display:inline">Novo artigo</p>
                    </a>
                    <!-- formulario para implementar filtros -->
                    <form method="GET" action="gerenciar_artigos.php" id="form-filtro">
                    ...
                    <div class="flip-scroll">
                        <div class="wrapper-scroll">
                            <table class="table table-bordered table-striped" id="artigos">
        ...
        <!-- popup "modal" do bootstrap para inserção de novo artigo -->
        <div class="modal fade" id="modal-novo-artigo" tabindex="-1" role="dialog" 
             aria-labelledby="modal-novo-artigo" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <!-- colocamos a tag form aqui para que possamos enviar o formulário
                        no rodapé do modal -->
                    <form method="POST" action="gerenciar_artigos.php ">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="titulo-novo">Título do artigo:</label>
                            ...
                            <div class="form-group">
                                <label for="autor-novo">Nome do autor do artigo:</label>
                            ...
                            <div class="form-group">
                                <label for="conteudo-novo">Conteúdo:</label>
                                <textarea name="conteudo" id="conteudo-novo" rows="8" cols="50"
                                    maxlength="65535" required
                                    title="O conteúdo do artigo deve ser preenchido e ter até
                                           65535 caracteres"
        ...
        <!-- popup "modal" do bootstrap para edição de artigo -->
        <div class="modal fade" id="modal-edita-artigo" tabindex="-1" role="dialog" 
             aria-labelledby="modal-edita-artigo" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <!-- colocamos a tag form aqui para que possamos enviar o formulário
                        no rodapé do modal -->
                    <form method="POST" action="rotinas/artigo/editar_artigo.php">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                X
                            </button>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="autor">Nome do autor do artigo:</label>
        ...
        <!-- popup "modal" do bootstrap para confirmação de remoção de artigo -->
        <div class="modal fade" id="modal-confirma-deleta" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <h4 class="modal-title">Remoção de artigo</h4>
                    </div>
                    <div class="modal-body">
                        <h3>Tem certeza que deseja remover "<span id="nome-artigo"></span>"?</h3>
                    </div>
                    <div class="modal-footer">
