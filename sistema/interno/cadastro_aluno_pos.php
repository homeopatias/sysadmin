        ...
        <?php
            ...
            if(isset($_POST["submit"])){
                ...
                if($nomeValido && $emailValido && $loginValido && $senhaValida && $cpfValido &&
                   $telefoneValido && $enderecoValido && $escolaridadeValida &&
                   $cursoValido && $cidadeMatValida && $telefonesOpcValidos){
                    ...
                    if ($linha = $query->fetch()){
                        ...
                        $conexao = null;
                        $sucesso = false;
                        echo "<script> alert(\"Usuário existente, faça o cadastro novamente! \"); window.location.href = \"cadastro_aluno_pos.php\";</script>";
                    }
