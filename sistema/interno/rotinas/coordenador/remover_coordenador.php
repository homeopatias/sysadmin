...
if($adminValido){
    ...
    // chave estrangeira de Administrador, o coordenador será automaticamente removido
    ...
    if($sucesso) {
        ...
        $mensagem = "Erro na remoção de coordenador";
    }
}
...
header('Location: ../../gerenciar_coordenadores.php'.$mensagem, true, "302");
die();