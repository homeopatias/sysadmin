    ...
    <head>
        ...
        <script>
            $(document).ready(function(){
                ...
                // passa os anos que o aluno estudou para escrever o select de anos
                var anos = new Array();
                <?php
                ...
                $textoQuery  = "SELECT C.ano 
                                ...
                                M.aprovado IS NOT NULL AND M.chaveCidade = C.idCidade 
                                ORDER BY C.ano DESC";
                    ...
                    <?php 
                        if(sizeof($selectAnos) >0){
                            echo ("<form method=\"GET\" 
                                action=\"trabalhos_aluno_experimental.php\" 
                                id=\"muda-ano\">
