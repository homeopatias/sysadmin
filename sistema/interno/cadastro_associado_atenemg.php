...
<html>
    <head>
        ...
        <title>Cadastro de associado ATENEMG - Homeopatias.com</title>
        <script>
    ...
    <body>
        <?php
            ...
            <script type="text/javascript">
                window.location.href = "index.php?mensagem=O cadastro na ATENEMG ainda não está aberto!";
            </script>
            ...
            if(isset($_POST["submit"])){
                ...
                if($nomeValido && $cpfValido && $emailValido && $loginValido && $senhaValida &&
                   $telefoneValido && $enderecoValido  && $formTerapeuticaValida){
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body"
                        ...
                        Xerox Autenticado em cartório da:
